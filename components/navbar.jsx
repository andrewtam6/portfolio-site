    ...
    return (
        <div className="absolute p-8 left-3/4 z-50">
            <div className="inline-flex">
                <nav className="">
                <Link href="/" className="p-4 text-white hover:text-gray-200 transition-colors duration-300  font-medium">Home</Link>
                <Link href="/profile" className="p-4 text-white hover:text-gray-200 transition-colors duration-300  font-medium">Projects</Link>
